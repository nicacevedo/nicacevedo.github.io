...
My research combines optimization and data-driven modeling for consequential systems. Current work spans equitable predictive modeling for property assessment, public-data modeling of data-center infrastructure and resource systems, and reliable large-scale first-order optimization on GPUs. Earlier work on feature selection and standardized-test screening remains available below; formal outputs are collected on the [Publications](/publications/) page.
